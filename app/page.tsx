...
import { site, roles, stats, blogPosts, countryFits, qaChecks, securityBasics, onboardingTimeline, globalWorkImages, stealthOffer, leadQuestions, staffingProcess, staffingFitNote } from './data';
...
export default function Home() {
  ...
  const faqSchema = {
    ...
    '@type': 'FAQPage',
    mainEntity: [
      { '@type': 'Question', name: 'How much does an overseas virtual assistant plan?', acceptedAnswer: { '@type': 'Answer', text: 'Many overseas admin and support VA roles fall in a planning range of a custom staffing planfor the role, depending on country, skill, schedule, English needs, and management support.' } },
