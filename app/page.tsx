...
import { site, roles, stats, blogPosts, countryFits, qaChecks, securityBasics, onboardingTimeline, globalWorkImages } from './data';
...
export default function Home() {
  ...
  return <><Header/><main>
    ...
    <section className="hero"><div className="container grid"><div><p className="eyebrow">overseas virtual assistant planning</p><h1>Hire overseas VA help without guessing.</h1><p className="lead">Overseas Virtual Assistant helps busy teams compare roles, costs, countries, time zones, quality checks, and security basics before they hire.</p><p>Start with a clear task list. Match the role to the right country and schedule. Add simple review rules before you hand over more work.</p><div className="actions"><a className="btn" href="/contact">Build my assistant plan</a><a className="btn secondary" href="/blog/virtual-assistant-costs">See cost ranges</a></div></div><div className="hero-visual card"><img src="https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&w=900&q=80" alt="Business owner meeting a remote overseas assistant team on a video call"/><div className="hero-checklist"><h3>Best first assistant tasks</h3><ul className="list"><li>Inbox sorting and calendar cleanup</li><li>Lead follow-up and CRM updates</li><li>Call answering and appointment setting</li><li>Customer support replies</li><li>Simple reports, research, and admin</li></ul><p className="quote">&quot;Start small, measure weekly, then add more work.&quot;</p></div></div></div></section>
